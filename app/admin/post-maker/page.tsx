...
export default function AdminPostMakerPage() {
  ...
  return (
    <div className="max-w-lg">
      <h1 className="text-2xl font-extrabold tracking-tight text-ink">AI Post Maker — Accès</h1>
      <p className="mt-1 text-sm text-muted">
        Active l’outil pour un élève (paiement Chariow, Mobile Money, Western Union…). Le compte doit déjà exister.
      </p>
